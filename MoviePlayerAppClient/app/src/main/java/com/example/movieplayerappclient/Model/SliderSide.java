package com.example.movieplayerappclient.Model;

public class SliderSide {
    public String video_slide, video_type, video_thumb, video_url,
            video_name, video_description, video_category;

    public SliderSide(String video_slide, String video_type, String video_thumb, String video_url,
